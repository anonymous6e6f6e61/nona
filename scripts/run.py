...
if __name__ == '__main__':
    ...
    legal_variants = ["nona"] + ananke1_variants + anankek_variants + synthetic_variants
    ...
    REMOTE_JAR = f"{REMOTE_ROOT}/target/streamingRetention-1.0.jar"
